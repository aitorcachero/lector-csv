      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {showColumnSelector && (
          <div className="fixed inset-0 z-50">
            {/* Backdrop con blur */}
            <div className="fixed inset-0 bg-black/60 backdrop-blur-sm" onClick={() => setShowColumnSelector(false)}></div>
            
            {/* Modal Container */}
            <div className="fixed inset-0 flex items-center justify-center p-4">
              <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden border border-gray-200 dark:border-gray-700">
                <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                  <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                    Seleccionar Columnas a Mostrar
                  </h2>
                  <p className="text-gray-600 dark:text-gray-300">
                    Tu archivo tiene {headers.length} columnas. Selecciona cuáles
                    quieres visualizar:
                  </p>
                </div>
                ...
                <div className="p-6 max-h-96 overflow-y-auto">
                  <div className="flex gap-2 mb-4">
                    <button
                      ...
                      className="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-md text-sm hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors"
                    >
                      Seleccionar Todas
                    </button>
                    <button
