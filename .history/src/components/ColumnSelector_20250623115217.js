        ...
        >
          ...
          <div className="p-6 max-h-96 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {headers.map((header) => (
                <label key={header} className={`flex items-center space-x-2 p-2 rounded-md cursor-pointer transition-colors duration-200 ${
                  isDarkMode
                    ? 'hover:bg-gray-700'
                    : 'hover:bg-gray-50'
                }`}>
          ...
          {/* Footer */}
          <div className={`p-6 border-t flex justify-end gap-3 transition-colors duration-300 ${
            isDarkMode 
              ? 'border-gray-600' 
              : 'border-gray-200'
          }`}>
