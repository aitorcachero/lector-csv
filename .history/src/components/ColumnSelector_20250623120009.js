      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        ...
        >
          ...
          >
            ...
            <button
              onClick={handleApply}
              className="px-4 py-2 text-sm font-medium text-white bg-black border border-transparent rounded-md hover:bg-green-700 transition-colors duration-200 cursor-pointer"
            >
              Aplicar
            </button>
          </div>
